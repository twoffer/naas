...
class TestEnrichmentAppliedVariants:
    ...
    async def test_ldap_match_produces_enrichment_applied_cache_hit_false(self):
    ...
    async def test_cache_hit_positive_produces_enrichment_applied_cache_hit_true(self):
    ...
    async def test_ldap_match_contributes_ldap_attrs_to_resolution(self):
...
class TestEnrichmentSkippedByOutcome:
    ...
    async def test_ldap_no_match_produces_no_ldap_match_skip(self):
        """Outcome 'ldap_no_match' → skip_reason='no_ldap_match'."""
        svc = _make_service(enrich_return=(None, "ldap_no_match"))
        result = await svc.normalize(_oidc_record())
    ...
    async def test_cache_hit_negative_produces_no_ldap_match_skip(self):
    ...
    async def test_ldap_timeout_produces_ldap_timeout_skip(self):
    ...
    async def test_ldap_connection_error_produces_ldap_connection_error_skip(self):
    ...
    async def test_ldap_search_error_produces_ldap_search_error_skip(self):
    ...
    async def test_ldap_unexpected_error_folds_into_ldap_search_error(self):
    ...
    async def test_unmappable_field_folds_into_ldap_search_error(self):
...
class TestEnrichmentSkippedByContext:
    ...
    async def test_ldap_disabled_in_config_produces_ldap_disabled_skip(self):
    ...
    async def test_ldap_protocol_produces_ldap_event_skip(self):
    ...
    async def test_missing_correlation_value_produces_invalid_correlation_key_skip(
        self,
    ):
...
class TestGracefulDegradation:
    ...
    async def test_every_skip_outcome_returns_valid_normalized_attributes(
        self, outcome
    ):
    ...
    async def test_ldap_disabled_still_normalizes_primary_attrs(self):
...
class TestNormalizationConfidenceOnOutput:
    ...
    async def test_oidc_single_source_has_nonzero_confidence(self):
    ...
    async def test_ldap_match_enrichment_produces_valid_confidence(self):
