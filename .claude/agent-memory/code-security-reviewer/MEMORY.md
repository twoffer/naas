...
- [Consumer + dual-write invariants](spec2-consumer-dualwrite-invariants.md) — SPEC_2 §5.1 chunk-6 ordering/XACK-last, empty-batch sleep CPU-peg fix, §5.4 outcome→skip_reason map, dead-table drift hazard
